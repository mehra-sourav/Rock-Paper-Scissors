...
import pandas as pd
import cv2
model=load_model('SegmentationSimplbgrnd.h5')#EModel20epoch,6convu6464finalconvu1024denseneurons,2310imgsrmspropsparselowdataugrescaleintrain.h5')
...
def Prediction():
    ...
    ImgSegment('INPUTIMAGE.jpg')
    pred_image1=image.load_img('INPUTIMAGE.jpg',target_size=(200,200),color_mode='grayscale')
